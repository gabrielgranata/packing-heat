...
class MapsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      home: MapSample(startingAddress: '59+Spark+St,+Ottawa,+ON', endingAddress: '100+Louis+Pasteur+Pvt,+Ottawa+ON',
       legs: args.legs
...
class MapSample extends StatefulWidget {
  ...
  final double startingLat = 45.423723;
  final double startingLng = -75.696406;
  final List legs;
